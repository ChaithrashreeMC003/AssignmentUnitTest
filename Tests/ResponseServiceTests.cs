...
namespace Tests
{
    ...
    public class ResponseServiceTests
    {
        ...
        public async Task CreateAsync_ShouldCreateTextResponse()
        {
            ...
            var dto = new CreateResponseDto { FeedbackText = "Test feedback", QuestionId = Guid.NewGuid(), UserSurveyId = Guid.NewGuid() };
            ...
            Assert.IsNull(result.OptionIds);
        }
        ...
        public async Task CreateAsync_ShouldCreateRatingResponse()
        {
            ...
            var dto = new CreateResponseDto { Rating = 5, QuestionId = Guid.NewGuid(), UserSurveyId = Guid.NewGuid() };
